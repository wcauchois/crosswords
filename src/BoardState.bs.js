...
function moveCursor(dirX, dirY, b, s) {
  ...
  var newCursorX = match[0] + dirX | 0;
  var newCursorY = match[1] + dirY | 0;
  if (!Board$Crosswords.isValidCoord(newCursorX, newCursorY, b) || Board$Crosswords.isBlocked(newCursorX, newCursorY, b)) {
    return s;
  } else {
    return /* record */[
            /* cursor : tuple */[
